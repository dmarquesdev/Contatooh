...
}return B.$resolved=!0,c.resource=B,c},function(a){return B.$resolved=!0,(y||m)(a),h.reject(a)});return F=F.then(function(a){var b=D(a);return(x||m)(b,a.headers),b},E),A?F:(B.$promise=F,B.$resolved=!1,B)},v.prototype["$"+e]=function(a,b,c){q(a)&&(c=b,b=a,a={});var d=v[e].call(this,a,this,b,c);return d.$promise||d}}),v.bind=function(a){return l(i,o({},j,a),r)},v}var m=b.noop,n=b.forEach,o=b.extend,p=b.copy,q=b.isFunction;return k.prototype={setUrlParams:function(a,c,d){var e,f,h=this,j=d||h.template,k=h.urlParams={};n(j.split(/\W/),function(a){if("hasOwnProperty"===a)throw g("badname","hasOwnProperty is not a valid parameter name.");!new RegExp("^\\d+$").test(a)&&a&&new RegExp("(^|[^\\\\]):"+a+"(\\W|$)").test(j)&&(k[a]=!0)}),j=j.replace(/\\:/g,":"),c=c||{},n(h.urlParams,function(a,d){e=c.hasOwnProperty(d)?c[d]:h.defaults[d],b.isDefined(e)&&null!==e?(f=i(e),j=j.replace(new RegExp(":"+d+"(\\W|$)","g"),function(a,b){return f+b})):j=j.replace(new RegExp("(/?):"+d+"(\\W|$)","g"),function(a,b,c){return"/"==c.charAt(0)?c:b+c})}),h.defaults.stripTrailingSlashes&&(j=j.replace(/\/+$/,"")||"/"),j=j.replace(/\/\.(?=\w+($|\?))/,"."),a.url=j.replace(/\/\\\./,"/."),n(c,function(b,c){h.urlParams[c]||(a.params=a.params||{},a.params[c]=b)})}},l}]})}(window,window.angular),angular.module("contatooh",["ngRoute","ngResource"]).config(["$routeProvider","$httpProvider",function(a,b){b.interceptors.push("meuInterceptor"),a.when("/contatos",{templateUrl:"partials/contatos.html",controller:"ContatosController"}),a.when("/contato/:contatoId",{templateUrl:"partials/contato.html",controller:"ContatoController"}),a.when("/contato",{templateUrl:"partials/contato.html",controller:"ContatoController"}),a.when("/auth",{templateUrl:"partials/auth.html"}),a.otherwise({redirectTo:"/contatos"})}]),angular.module("contatooh").factory("Contato",["$resource",function(a){return a("/contatos/:id")}]),angular.module("contatooh").factory("meuInterceptor",["$location","$q",function(a,b){var c={responseError:function(c){return 401==c.status&&a.path("/auth"),b.reject(c)}};return c}]),angular.module("contatooh").controller("ContatosController",["$scope","Contato",function(a,b){function c(){b.query(function(b){a.contatos=b,a.mensagem={}},function(b){console.log(b),a.mensagem={texto:"Não foi possível obter a lista de contatos"}})}a.contatos=[],a.filtro="",a.mensagem={texto:""},a.remove=function(d){b["delete"]({id:d._id},c,function(b){console.log(b),a.mensagem={texto:"Não foi possível remover o contato"}})},a.init=function(){c()},a.init()}]),angular.module("contatooh").controller("ContatoController",["$scope","$routeParams","Contato",function(a,b,c){b.contatoId?c.get({id:b.contatoId},function(b){a.contato=b},function(b){a.mensagem={texto:"Não foi possível obter o contato."},console.log(b)}):a.contato=new c,a.salva=function(){a.contato.$save()},c.query(function(b){a.contatos=b})}]);